    ...
    linhas = [
        {
            ...
            "data_emissao": getattr(r, "data_emissao", None),
            "modelo": getattr(r, "modelo", None),
            "serie": getattr(r, "serie", None),
            "numero_nf": getattr(r, "numero_nf", None),
            "valor_centavos": getattr(r, "valor_centavos", None),
