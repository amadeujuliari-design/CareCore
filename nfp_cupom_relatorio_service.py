...
async def relatorio_cupons(
    ...
    *,
    ...
    """Consolida cupons lidos por periodo (fuso operacional SP) e captador/unidade."""
    ...
    limite_n = max(1, min(int(limite or 2000), 5000))
    ...
    # Totais por status no filtro (sem limite de linhas).
    q_totais = (
    ...
    # Inclui status inesperados, se houver.
    ...
    # Lista de captadores distintos na org (para filtro no front).
    caps_org = (
        await db.execute(
    ...
    return {
        ...
        "linhas": linhas,
        "linhas_truncadas": total_lidos > limite_n,
