...
class AcompanhamentoPotDB(Base):
    ...
    atividade = Column(Text, nullable=True)
...
class NfpCupomLidoDB(Base):
    ...
    # rejeitado_prazo = fora da janela NFP (retrasado+passado ate dia 20 vigente; leitura +1 dia)
    consumidor_identificado = Column(Boolean, nullable=True)
    cnpj_emitente = Column(String, nullable=True)
    data_emissao_ref = Column(String, nullable=True)
    data_emissao = Column(String, nullable=True)
    uf_ibge = Column(String, nullable=True)
